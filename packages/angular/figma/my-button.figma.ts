...
figma.connect(
  'https://www.figma.com/design/13EjEqM5aIyM7HCBxp4Put/Web-Components-%2F-Dev-mode?node-id=1-5',
  {
    props: {
    ...
    example: ({ textContent, disabled, startIcon }) =>
      html`<my-button ${disabled}>${startIcon}${textContent}</my-button>`,
    imports: ["import { MyButton } from '@stencil-demo/angular';"],
  }
);
